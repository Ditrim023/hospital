...
public class DataLoader implements ApplicationRunner {
  ...
  private static final String DATE_BIRTH = "15-07-1990";
  ...
  private void insertHospitalUsers() {
    HospitalUser hospitalUser1 = new HospitalUser("Nikita", "Krutoguz", "user0", new BCryptPasswordEncoder(10).encode(PASS), "07-02-1990", "Admin");
    ...
    HospitalUser hospitalUser2 = new HospitalUser("Yra", "Knish", "user1", new BCryptPasswordEncoder(10).encode(PASS), "24-05-1990", "LOR");
    ...
    HospitalUser hospitalUser3 = new HospitalUser("Leha", "Evty", "user2", new BCryptPasswordEncoder(10).encode(PASS), "26-02-1989", "Therapist");
    ...
    HospitalUser hospitalUser4 = new HospitalUser("Maks", "Kop", "user3", new BCryptPasswordEncoder(10).encode(PASS), DATE_BIRTH, "Surgeon");
    ...
    HospitalUser hospitalUser5 = new HospitalUser("Alfred", "All", "user4", new BCryptPasswordEncoder(10).encode(PASS), DATE_BIRTH, "LOR");
    ...
    HospitalUser hospitalUser6 = new HospitalUser("Balfred", "All", "user5", new BCryptPasswordEncoder(10).encode(PASS), DATE_BIRTH, "Therapist");
    ...
    HospitalUser hospitalUser7 = new HospitalUser("Seven", "Sevenovich", "user6", new BCryptPasswordEncoder(10).encode(PASS), DATE_BIRTH, "Surgeon");
